function handles = cl_UpdateAbortRate(handles,variables,ABOind,f)
%handles = cl_UpdateAbortRate(handles,variables,ABOind,ALLind,f)
%
%Custom function for Caras Lab
%
%This function calculates and displays the trial abort rate. 
%
%Inputs:
%   handles: GUI handles structure
%   variables: matrix containing roved parameter information for each trial
%   ABOind: logical index vector for aborts
...
idx = ~cellfun('isempty',strfind(flds,'FArate')); %#ok<*STRCL1>
flds = flds(idx);
...
switch grpstr{grpval}
    ...
    otherwise
        ...
        grp_ind = cl_FindColumnIndex(ROVED_PARAMS,grpstr(grpval),handles);
