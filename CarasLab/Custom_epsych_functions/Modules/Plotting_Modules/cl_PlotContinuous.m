function cl_PlotContinuous(timestamps,TTL,ax,clr,xmin,xmax,varargin)
%cl_PlotContinuous(timestamps,TTL,ax,clr,xmin,xmax,varargin)
%
...
%
%Example usage: 
%   cl_PlotContinuous(timestamps,spout_hist,...
