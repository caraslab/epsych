function handles = cl_UpdateIOPlot_AFC(handles,variables,HITind,GOind,REMINDind)
%handles = cl_UpdateIOPlot_AFC(handles,variables,HITind,GOind,REMINDind)
%
%Custom function for Caras Lab. Use only for AFC paradigms.
%
...
col_ind = cl_FindColumnIndex(ROVED_PARAMS,x_strings{x_ind},handles);
