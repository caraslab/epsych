function handles = cl_UpdateTrialHistory(handles,variables,reminders,HITind,FAind,GOind)
%handles = cl_UpdateTrialHistory(handles,variables,reminders,HITind,FAind,GOind)
%
