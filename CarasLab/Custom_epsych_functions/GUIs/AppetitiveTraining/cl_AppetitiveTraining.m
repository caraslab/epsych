function varargout = cl_AppetitiveTraining(varargin)
%
%cl_AppetitiveTraining({'C:\Users\...*.rcx'},{'Title String'})
%
...
%
%See cl_AppetitiveTrainingMenu.m for more detailed information.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @cl_AppetitiveTraining_OpeningFcn, ...
                   'gui_OutputFcn',  @cl_AppetitiveTraining_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function cl_AppetitiveTraining_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = cl_AppetitiveTraining_OutputFcn(hObject, ~, handles) 
