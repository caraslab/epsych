function varargout = cl_basic_characterization(varargin)
% CL_BASIC_CHARACTERIZATION MATLAB code for cl_basic_characterization.fig
%      CL_BASIC_CHARACTERIZATION, by itself, creates a new CL_BASIC_CHARACTERIZATION or raises the existing
%      singleton*.
%
%      H = CL_BASIC_CHARACTERIZATION returns the handle to a new CL_BASIC_CHARACTERIZATION or the handle to
%      the existing singleton*.
%
%      CL_BASIC_CHARACTERIZATION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CL_BASIC_CHARACTERIZATION.M with the given input arguments.
%
%      CL_BASIC_CHARACTERIZATION('Property','Value',...) creates a new CL_BASIC_CHARACTERIZATION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cl_basic_characterization_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cl_basic_characterization_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @cl_basic_characterization_OpeningFcn, ...
                   'gui_OutputFcn',  @cl_basic_characterization_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function varargout = cl_basic_characterization_OutputFcn(~, ~, handles) 
